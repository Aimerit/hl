...
export const SEARCH_SUPPLIERS_REQUEST = 'SEARCH_SUPPLIERS_REQUEST';
export const SEARCH_SUPPLIERS_SUCCESS = 'SEARCH_SUPPLIERS_SUCCESS';
export const SEARCH_SUPPLIERS_FAILURE = 'SEARCH_SUPPLIERS_FAILURE';

export const GET_SUPPLIERS_ANALYTICS_REQUEST = 'GET_SUPPLIERS_ANALYTICS_REQUEST';
export const GET_SUPPLIERS_ANALYTICS_SUCCESS = 'GET_SUPPLIERS_ANALYTICS_SUCCESS';
export const GET_SUPPLIERS_ANALYTICS_FAILURE = 'GET_SUPPLIERS_ANALYTICS_FAILURE';

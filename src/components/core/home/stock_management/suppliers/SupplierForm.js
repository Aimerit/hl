...
function SupplierForm({ supplier = {}, formErrors, onChange }) {
  return (
    <FormContainer>
      ...
      <FormField type='text' name='companyName' label='Nom du fournisseur' defaultValue={supplier.companyName} error={formErrors.companyName} required onChange={onChange} />
      ...
      <AddressForm property='officeAddress' address={supplier.officeAddress} formErrors={formErrors.officeAddress} required onChange={onChange} />
    </FormContainer>
  );
}
